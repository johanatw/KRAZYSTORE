...
// Configuración de confirmación y notificaciones
...
// Abrir diálogo para registrar cliente
...
// Calcular IVA 5%
const calcularIva5 = () => {
    let detalle = selectedProduct.value;
...
// Verificar si un item es facturable
...
// Verificar si hay pendiente pero sin stock
...
// Función de prueba para manejar cambios en cantidad
