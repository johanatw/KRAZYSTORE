        ...
        datasets: [
            {
                ...
                data: chartIngresosEgresosUltimos6Meses.value?.ingresosVenta
            },
            {
                type: 'bar',
                label: 'Anticipos',
                backgroundColor: documentStyle.getPropertyValue('--p-yellow-300'),
                data: chartIngresosEgresosUltimos6Meses.value?.ingresosAnticipo
            },
            
            {
                ...
                data: chartIngresosEgresosUltimos6Meses.value?.ingresosOtros
            }
        ]
    };
};
