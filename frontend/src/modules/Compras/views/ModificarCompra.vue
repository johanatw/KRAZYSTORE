...
const isFromRecepcion = () => {
    return compra.value.recepcion != null;
}
...
const esCompraInternacional = (tipoProveedor) => {
    return tipoProveedor == 'Extranjero';
}

// Función para manejo de clientes
const search = (event) => {
    setTimeout(() => {
...
// Funciones para cálculos de totales
const sendSubTotal = () => {
    let monto= 0;
    detalleFacturar.value.forEach(e => {
...
const guardarFactura = () => {
    if (!error.value) {
        ...
        let ant = {
            ...
            proveedor: selectedCliente.value, 
...
<div class="flex justify-content-center">
    ...
    <Panel style="position: relative; width: 80%;">
        ...
        <div class="grid">
            ...
            <div class="col-12">
                <!-- Vista cuando hay pedido asociado -->
                ...
                <!-- Vista cuando hay recepción asociada -->
                ...
                <!-- Vista por defecto - sin pedido ni recepción asociada -->
