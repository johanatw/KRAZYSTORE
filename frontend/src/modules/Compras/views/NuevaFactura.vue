...
const eliminar = (detalle) => {
 ...
 const verCompra = (id) =>{
  ...
  const guardarFactura = () =>{
    ...
    let ant = {total: total.value, fecha: fechaCompra.value, estado: 'N', proveedor: selectedCliente.value, nroFactura: nroFactura.value, recepcion: {id: recepcion.value.id}};
